...
create user 'edytor1'@'localhost';
GRANT UPDATE,INSERT,DELETE,SELECT ON 4e_1_perfumy.* TO 'edytor1';

-- 3. Utwórz użytkownika selektor z prawami do wyszukiwania danych w tabeli perfumy z hasłem 1234
CREATE user 'selektor1'@'localhost' identified by '1234';

GRANT SELECT on 4e_1_perfumy.perfumy to 'selektor1';
-- 4. Nadaj hasło użytkownikowi edytor 1234 oraz użytkownikowi selektor 5678
ALTER USER 'edytor1'@'localhost' IDENTIFIED BY '1234';
-- 5. Odbierz użytkownikowi edytor prawo do usuwania danych z wszystkich tabel

REVOKE DELETE ON 4e_1_perfumy.* FROM 'edytor1'@'localhost';
