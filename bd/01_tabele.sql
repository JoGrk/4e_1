...
(
    id_prac int auto_increment primary key,
    nazwisko varchar(25) unique,
    zarobki dec(6,2) DEFAULT 1900
);

-- 6. 
-- Tabela działy z polami kod, nazwa (ma się nie powtarzać) i budżet(domyślnie 100 tysięcy)
CREATE TABLE dzialy
(
...
CREATE TABLE niewolnicy
(
    id int auto_increment primary key,
    imie varchar(255),
    nazwisko varchar(255) not NULL,
    kod char(4),
    foreign key (kod) references dzialy (kod) 
);
